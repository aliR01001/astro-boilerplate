...
2. **TypeScript Interface**: Create interface in `src/types/shared.ts` for section props
3. **Component Location**: Place in `src/components/sections/{goodNameforTheRuasableSection}.astro`
...
- **Components**: `/ui` (reusable) | `/sections/goodNameforTheRuasableSection.astro/` 
